...
local bot_id = 193890204
   — like local bot_id = 1234567
    ...
    elseif msg.action.type == "chat_add_user" and msg.action.user.id == tonumber(bot_id) and not is_sudo(msg) then
      send_large_msg("chat#id"..msg.to.id, 'this is not one of my groups. i like to add my Dady for spam', ok_cb, false)
      chat_add_user("chat#id"..msg.to.id, 'user#id162108576', ok_cb, false)
      chat_del_user("chat#id"..msg.to.id, 'user#id'..bot_id, ok_cb, false)
